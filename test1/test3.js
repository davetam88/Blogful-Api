// 18.15 - test3.js
// 5.1.Bonus! Let's make a test and endpoint for GET /articles/:article_id
...
describe.only('Articles Endpoints', function () {
  ...
  it('GET /articles responds with 200 and all of the articles', () => {
    console.log(`---GET /articles responds with 200 and all of `); // dbg..
...
context('Given there are articles in the database', () => {
  ...
  beforeEach('BEFOREEACH:  insert articles', () => {
    console.log(`--- BEFOREEACH:  insert articles`); // dbg..
    return db
